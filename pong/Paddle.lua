...
--[[
    The updateAI function takes the ball from parameter and converts the y coordinates of the
    paddle in a way that the center of the paddle and the center if the ball
    are always aligned. Thus, the ball always hits the center of the AI paddle.
]]
